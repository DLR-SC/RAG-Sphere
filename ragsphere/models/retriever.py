...
from ragsphere.protocols.retriever import BaseRetrieverConfig

from ragsphere.models.enums import RetrieverType
...
class VectorGRRetrieverConfig(BaseRetrieverConfig):
    ...
    filters: Dict[str, Any] | None = (
        None  # Filters for metadata pre-filtering. When performing a similarity search, one may have constraints to apply. For instance, filtering out movies released before 2000. This can be achieved using filters.
    )
