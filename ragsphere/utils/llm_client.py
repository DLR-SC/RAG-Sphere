...
class LLMClient:
    ...
    def generate(
        ...
        *,
        ...
        format: Optional[
            Union[dict, str]
        ] = None,  # ToDo see here: https://github.com/openai/openai-python/blob/main/src/openai/resources/chat/completions/completions.py#L1045
        ...
        **kwargs,
        ...
        if self.provider == "ollama":
            ...
            if format is not None:
                logger.warning(
                    "JSon Formats are not yet supported for openai providers. This method might return unexpected results!"
                )
            ...
            r = self.client.chat.completions.create(
                model=model, messages=chat, stream=stream, **options, **kwargs
            )
    ...
    def embed(
        ...
        if self.provider == "ollama":
            ...
            r = self.client.embeddings.create(
                input=input, model=model, encoding_format=encoding_format, **options
            )
